...
import 'package:ramanas_waiter/UI/Landing/Products/product_helper.dart';

class ThermalProductsReceiptDialog extends StatefulWidget {
  final GetProductsCatModel getProductsCatModel;
  const ThermalProductsReceiptDialog(this.getProductsCatModel, {super.key});
                  ...
                  ElevatedButton.icon(
                    onPressed: () async {
                      try {
                        ...
                        Uint8List? imageBytes = await captureMonochromeProducts(
                          productKey,
                        );
