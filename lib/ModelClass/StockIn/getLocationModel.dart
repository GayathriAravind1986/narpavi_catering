...
class GetLocationModel {
  GetLocationModel({bool? success, Data? data, ErrorResponse? errorResponse}) {
    _success = success;
    _data = data;
  }
  ...
  GetLocationModel copyWith({bool? success, Data? data}) =>
      GetLocationModel(success: success ?? _success, data: data ?? _data);
...
class Data {
  Data({String? id, String? locationId, String? locationName}) {
    _id = id;
  ...
  Data copyWith({String? id, String? locationId, String? locationName}) => Data(
    id: id ?? _id,
